...
#define CONTROL_TOPIC "/cmd_vel_mux/input/teleop" // changed for turtlebot
...
private:
  ...
  double evaluateAction(double direction, double velocity, bool debug,double &debug_Conformance,double &debug_Continue, double &debug_Distance,double &debug_Safety);
	/**
  ...
  ros::Publisher mControlStopPublisher;
